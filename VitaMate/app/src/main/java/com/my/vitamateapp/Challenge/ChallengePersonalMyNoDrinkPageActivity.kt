...
import com.my.vitamateapp.databinding.ActivityPersonalChallengeMyNoDrinkPageBinding
...
class ChallengePersonalMyNoDrinkPageActivity : AppCompatActivity() {
    private var selectedDate: CalendarDay? = null
    private lateinit var binding: ActivityPersonalChallengeMyNoDrinkPageBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 바인딩 초기화
        binding = DataBindingUtil.setContentView(this, R.layout.activity_personal_challenge_my_no_drink_page)
    ...
    private inner class SelectedDayDecorator : DayViewDecorator {
        private var selectedDate: CalendarDay? = null
        private val drawable = ContextCompat.getDrawable(this@ChallengePersonalMyNoDrinkPageActivity, R.drawable.transparent_calendar_element)
    ...
    private inner class TodayDecorator : DayViewDecorator {
        private val drawable = ContextCompat.getDrawable(this@ChallengePersonalMyNoDrinkPageActivity, R.drawable.calendar_circle_white)

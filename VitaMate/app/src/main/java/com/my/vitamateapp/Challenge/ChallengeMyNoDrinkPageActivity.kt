...
class ChallengeMyNoDrinkPageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        toggleCalendarView.isChecked = false // 주간 보기 초기 상태
            ...
            if (selected) {
                selectedDate?.let {
                    ...
                    calendarView.addDecorators(TodayDecorator(),
                        com.my.vitamateapp.Challenge.ChallengeMyNoDrinkPageActivity.SundayDecorator(),
                        com.my.vitamateapp.Challenge.ChallengeMyNoDrinkPageActivity.SaturdayDecorator()
                    )
                }
...
//                        }
    ...
    private inner class SelectedDayDecorator(private val selectedDate: CalendarDay) :
        ...
        private val drawable = ContextCompat.getDrawable(
            this@ChallengeMyNoDrinkPageActivity,

...
import com.my.vitamateapp.databinding.ActivityPersonalChallengeMyNoSmokePageBinding
...
class ChallengePersonalMyNoSmokePageActivity : AppCompatActivity() {
    private var selectedDate: CalendarDay? = null
    private lateinit var binding: ActivityPersonalChallengeMyNoSmokePageBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 바인딩 초기화
        binding = DataBindingUtil.setContentView(this, R.layout.activity_personal_challenge_my_no_smoke_page)
    ...
    private inner class SelectedDayDecorator : DayViewDecorator {
        private var selectedDate: CalendarDay? = null
        private val drawable = ContextCompat.getDrawable(this@ChallengePersonalMyNoSmokePageActivity, R.drawable.transparent_calendar_element)
    ...
    private inner class TodayDecorator : DayViewDecorator {
        private val drawable = ContextCompat.getDrawable(this@ChallengePersonalMyNoSmokePageActivity, R.drawable.calendar_circle_white)
